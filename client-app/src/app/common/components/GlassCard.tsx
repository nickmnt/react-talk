...
const useStyles = (c: string, blur: number = 7) =>
    makeStyles((theme: Theme) => ({
        glass: {
            ...
            backgroundImage: `linear-gradient(to bottom right, ${color(c).alpha(0.2).toString()}, ${color(c).alpha(0).toString()})`,
...
export function GlassCard(props: GlassCardProps) {
    const { color = '#ffffff', blur, noBorders, square, className, ...rest } = props;
