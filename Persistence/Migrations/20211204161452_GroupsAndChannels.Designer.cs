...
namespace Persistence.Migrations
{
    ...
    [Migration("20211204161452_GroupsAndChannels")]
    partial class GroupsAndChannels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Direct.ChannelMembership", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Direct.GroupMembership", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Direct.ChannelMembership", b =>
                {
                    ...
                    b.HasOne("Domain.Direct.ChannelChat", "Channel")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Domain.Direct.GroupMembership", b =>
                {
                    ...
                    b.HasOne("Domain.Direct.GroupChat", "Group")
                        .WithMany("Members")
